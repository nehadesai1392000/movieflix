...
import { thadData } from '../redux/netflixSlice';
...
const TopRated = () => {
  ...
  const useData = useSelector((state: any) => state?.netflixOriginals?.para);
  const imageUrl = "https://image.tmdb.org/t/p/original/"

  console.log(useData.data?.results[0]?.poster_path);
  useEffect(() => {
    axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&language=en-US`).then((response: any) => dispatch(thadData(response)))
  }, []);
