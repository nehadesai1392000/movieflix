...
import { secondData } from '../redux/netflixSlice';
...
// img Data//
    ...
    const useData = useSelector((state: any) => state?.netflixOriginals?.data);
    const imageUrl = "https://image.tmdb.org/t/p/original/"
  
    console.log(useData.data?.results[0]?.backdrop_path);
  
  
  
    useEffect(() => {
      axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_networks=213`).then((response: any) => dispatch(secondData(response)))
    }, []);
