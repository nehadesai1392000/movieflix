...
import "../style/ActionMovies.css"
import { useDispatch } from 'react-redux';
import axios from 'axios';
import { forData } from '../redux/netflixSlice';
...
const ActionMovies = () => {
  ...
  const useData = useSelector((state: any) => state?.netflixOriginals?.item);
  const imageUrl = "https://image.tmdb.org/t/p/original/"

  console.log(useData.data?.results[0]?.poster_path);
  useEffect(() => {
    axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_genres=28`).then((response: any) => dispatch(forData(response)))
  }, []);
