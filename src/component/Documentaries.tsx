...
import { sevenData } from '../redux/netflixSlice';
...
import "../style/Documentaries.css"
...
const useData = useSelector((state: any) => state?.netflixOriginals?.doc);
const imageUrl = "https://image.tmdb.org/t/p/original/"

console.log(useData.data?.results[0]?.poster_path);
useEffect(() => {
axios.get(` https://api.themoviedb.org/3/discover/movie?api_key=224ce27b38a3805ecf6f6c36eb3ba9d0&with_genres=99`).then((response: any) => dispatch(sevenData(response)))
}, []);
...
<div className='new-slider-imgPath'>
            ...
            return (
              <SwiperSlide>
                <div className='netflix-gerund'>
                  <img src={`${imageUrl}${movies.backdrop_path}`} alt="" width={"280"} onClick={() => showDetails(movies)} />
                </div>
                <Modal
                  centered
                  open={open}
      ...
      <div className='Made-Andres'>
        <p>© 2023 Made with ❤️ by <b> Neha Desai </b></p>
      </div>
